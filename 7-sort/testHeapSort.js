...
runTests({
  description: "Testing heap sort: digits",
...
runTests({
  description: "Testing heap sort: sorted",
...
runTests({
  description: "Testing heap sort: reversed",
